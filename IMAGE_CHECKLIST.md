...
Drop images into the paths below. When a file is missing, the UI shows a paper (`#F5F1E9`) fallback with the title text.

## Convention

| Type | Path | Aspect | Min size | Notes |
|------|------|--------|----------|-------|
...
### heartbreak
- [ ] `public/works/until-dawn/cover.png`
- [ ] `public/works/grammar-of-parting/cover.png`
- [ ] `public/works/chemistry-of-tears/cover.png`
- [ ] `public/works/ex-bookshelf/cover.png`
- [ ] `public/works/seventy-two-hours/cover.png`

### wine-deep
- [ ] `public/works/terroir-notes/cover.png`
- [ ] `public/works/glass-and-pour/cover.png`
- [ ] `public/works/burgundy-walk/cover.png`
- [ ] `public/works/pairing-at-home/cover.png`
- [ ] `public/works/natural-wine-era/cover.png`

### baystars-success
- [ ] `public/works/stadium-experience/cover.png`
- [ ] `public/works/community-blue/cover.png`
- [ ] `public/works/data-and-emotion/cover.png`
- [ ] `public/works/sponsor-value/cover.png`
- [ ] `public/works/youth-pipeline/cover.png`

### ohtani-mind
- [ ] `public/works/dual-discipline/cover.png`
- [ ] `public/works/quiet-ambition/cover.png`
- [ ] `public/works/recovery-science/cover.png`
- [ ] `public/works/focus-protocol/cover.png`
- [ ] `public/works/team-leadership/cover.png`

### twenties-goals
- [ ] `public/works/twenty-design/cover.png`
- [ ] `public/works/solo-living/cover.png`
- [ ] `public/works/adventure-budget/cover.png`
- [ ] `public/works/weak-ties/cover.png`
- [ ] `public/works/health-capital/cover.png`

## PWA icons (already generated as placeholders)
- [x] `public/icons/icon-192.png`
- [x] `public/icons/icon-512.png`

Replace with branded icons when ready.
